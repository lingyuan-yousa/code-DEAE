...
from comparative_experiments_daqing.DenoisingAuto_Encoder.deae_utils import perf_metric
...
class DenoisingAutoencoder(nn.Module):
    ...
    def train_model(self, x_unlab, p_m, parameters, x_train, y_train, x_test, y_test, seed):
        ...
        for epoch in range(epochs):
            ...
            for xu_batch, _ in dataloader:  # xu_batch is directly obtained from DataLoader
